...
Compartilhe o perfil no Facebook ou Twitter</p>
      ...
      <section className="comofunciona">
        <div className="content">
          ...
          <h3>Receba</h3>
          <p className="text-content">Quando sua campanha finalizar receba o valor arrecadado diretamente em sua conta e poste a evolução do quadro clínico do animal.
