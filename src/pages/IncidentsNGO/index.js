...
function IncidentsNGO({ isFocused }) {
  ...
  function navigateToDetail(incident) {
    navigation.navigate('IncidentNGODetail', { incident });
  }
  return (
    <>
    ...
    <View style={styles.container} >
      ...
      <Text style={styles.title}>List of cases of animals registered by the NGO. </Text>
...
export default withNavigationFocus(IncidentsNGO);